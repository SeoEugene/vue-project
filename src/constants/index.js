...
export const skillText = [
    ...
    {
        title: "해결하기",
        desc: "하나의 방법만이 아닌 여러가지의 방법을 생각해보고 궁금한 점이 있으면 참지못함 나는 기술적 도전에 힘겨움을 느끼지 않는 탐구자입니다. 복잡한 문제에 직면했을 때 논리적으로 접근하고, 단 하나의 해결책이 아니라 다양한 접근 방식을 고민합니다. 새로운 기술을 습득하는 것을 즐기며, 궁금한 것이 생기면 그 궁금증을 해결하려는 불타는 열정을 가지고 있습니다. 어려운 기술적 과제에 도전하는 것을 두려워하지 않으며, 항상 더 나은 방법과 혁신을 찾고자 노력합니다",
    }
]
